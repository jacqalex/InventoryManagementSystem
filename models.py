...
class ItemMaster(db.Model):
    ...
    ItemCatID = db.Column(db.Integer, db.ForeignKey(
        "itemscategory.ItemCatID"), nullable=False)
    ItemDesc = db.Column(db.String, nullable=False)
    AvailAmt = db.Column(db.Integer, nullable=False)
    itemCat = db.relationship("ItemCategory", backref="ItemCategory", lazy=True)
...
class AddItem(db.Model):
    ...
    ItemID = db.Column(db.Integer, db.ForeignKey(
        "itemmaster.ItemID"), nullable=False)
...
class request_tbl(db.Model):
    ...
    userID = db.Column(db.Integer, db.ForeignKey(
        "user_tbl.userID"), nullable=False)
